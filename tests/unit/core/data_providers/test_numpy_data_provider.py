...
class TestNDArrayUnivariateProvider:
    ...
    def test_len_returns_correct_length(self, univariate_float64_array: NumericArray) -> None:
        """Test that __len__ returns correct number of observations."""
        provider = NDArrayUnivariateProvider(univariate_float64_array)
        assert len(provider) == 5

    def test_len_with_empty_array(self, univariate_empty_array: NumericArray) -> None:
        """Test that __len__ returns 0 for empty array."""
        provider = NDArrayUnivariateProvider(univariate_empty_array)
        assert len(provider) == 0

    def test_len_with_single_element(self, univariate_single_element_array: NumericArray) -> None:
        """Test that __len__ returns 1 for single element array."""
...
class TestNDArrayMultivariateProvider:
    ...
    def test_len_returns_correct_length(self, multivariate_float64_array: NumericArray) -> None:
        """Test that __len__ returns correct number of observations."""
        provider = NDArrayMultivariateProvider(multivariate_float64_array)
        assert len(provider) == 3

    def test_len_with_empty_array(self, multivariate_empty_array: NumericArray) -> None:
        """Test that __len__ returns 0 for empty array."""
        provider = NDArrayMultivariateProvider(multivariate_empty_array)
        assert len(provider) == 0

    def test_len_with_single_observation(self, multivariate_single_observation_array: NumericArray) -> None:
        """Test that __len__ returns 1 for single observation."""
    ...
    def test_empty_2d_array_with_zero_columns(self) -> None:
        """Test empty array with zero columns is accepted."""
